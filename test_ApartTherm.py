...
if __name__ == '__main__':
    ...
    for _ in range(1):
        ...
        np.savez(f'test_ApartTherm_result_with_pdbo_PH_{now_time_str}', safe_ave_cost_arr, safe_ave_simple_regret_arr, con_ave_cost_arr, con_ave_simple_regret_arr, vabo_ave_cost_arr_set,
