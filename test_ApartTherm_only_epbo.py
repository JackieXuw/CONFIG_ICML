...
np.savez(
    f'test_ApartTherm_result_with_pdbo_{epbo_penalty_list[0]}_{epbo_penalty_list[1]}_{epbo_penalty_list[2]}_{now_time_str}', safe_ave_cost_arr, safe_ave_simple_regret_arr, con_ave_cost_arr, con_ave_simple_regret_arr, vabo_ave_cost_arr_set,
