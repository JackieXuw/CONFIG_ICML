...
def run_one_instance(base_opt_config, problem_config):
...
if __name__ == '__main__':
    ...
    for _ in range(1):
        safe_costs, safe_objs, con_costs, con_objs, \
            ...
            con_obj_traj, con_constrs, pdbo_obj_traj, pdbo_constrs, \
            lcb2_costs, lcb2_objs, lcb2_opt, lcb2_obj_traj, lcb2_constrs \
            = run_one_instance(base_opt_config, problem_config)
        ...
        for safe_costs, safe_objs, con_costs, con_objs, \
            ...
            lcb2_opt, lcb2_obj_traj, lcb2_constrs in multi_results:
        ...
        np.savez(
            'test_WO', safe_ave_cost_arr, safe_ave_simple_regret_arr,
