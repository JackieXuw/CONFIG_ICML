...
import simple_util
from lcb2 import optimization_problem
...
def run_one_instance(x):
    ...
    return safe_costs, safe_objs, con_costs, con_objs, vabo_costs_tmp, \
        ...
        lcb2_obj_traj, lcb2_constrs, epbo_costs_0, epbo_objs_0, \
...
if __name__ == '__main__':
    ...
    for _ in range(1):
        ...
        epbo_opt_0, epbo_obj_traj_0, epbo_constrs_0, epbo_costs_1, epbo_objs_1, \
        epbo_opt_1, epbo_obj_traj_1, epbo_constrs_1, epbo_costs_2, epbo_objs_2, \
        epbo_opt_2, epbo_obj_traj_2, epbo_constrs_2 = run_one_instance(0)
        ...
        for safe_costs, safe_objs, con_costs, con_objs, vabo_costs_tmp, vabo_objs_tmp,\
            ...
            lcb2_constrs, epbo_costs_0, epbo_objs_0, \
        epbo_opt_0, epbo_obj_traj_0, epbo_constrs_0, epbo_costs_1, epbo_objs_1, \
        epbo_opt_1, epbo_obj_traj_1, epbo_constrs_1, epbo_costs_2, epbo_objs_2, \
