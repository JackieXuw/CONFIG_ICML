...
# In[87]:
    ...
    np.savez('test_GP_sample_result_with_pdbo_epbo', safe_ave_cost_arr, safe_ave_simple_regret_arr, con_ave_cost_arr, con_ave_simple_regret_arr, vabo_ave_cost_arr_set,
