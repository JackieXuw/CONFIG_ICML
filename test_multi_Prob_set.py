...
import os
from global_problems_multi import get_config
...
np.savez(f'./result/test_multi_Prob_set_result_with_pdbo_{now_time_str}_penaty_{epbo_penalty_list[0]}_{epbo_penalty_list[1]}_{epbo_penalty_list[2]}', safe_ave_cost_arr, safe_ave_simple_regret_arr, con_ave_cost_arr, con_ave_simple_regret_arr,
