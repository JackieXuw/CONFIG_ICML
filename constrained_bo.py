...
class ConstrainedBO:
    ...
    def __init__(self, opt_problem, constrained_BO_config):
        ...
        #self.gps_torch = gp_model.BOGPModels(
        # opt_problem.train_X, opt_problem.train_obj, opt_problem.train_constr,
        #                   self.x0_arr, safe_obj_arr, safe_constr_arr)
    ...
    def get_acquisition(self, type='constrained_EI', gp_package='gpy'):
    ...
    def make_step(self):
        ...
        #self.gps_torch.add_new_data_point(x_next, y_obj, constr_vals, update_hyper_params=False)
        return y_obj, constr_vals
