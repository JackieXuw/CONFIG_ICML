...
def get_epbo_result(problem_config, plot=False, penalty=1.0):
    ...
    #print('epbo', optimization_config['eval_budget'])
    for _ in range(optimization_config['eval_budget']):
    #if True:
        #if True:
...
def run_one_instance(x):
    ...
    #else:
        constr_func = problem_config['constrs_list'][0]
    ...
    return safe_costs, safe_objs, con_costs, con_objs, vabo_costs_tmp, \
        ...
        lcb2_obj_traj, lcb2_constrs, problem_config, epbo_obj_traj_0, epbo_constrs_0, \
...
for _ in range(50): #50):
    ...
    multi_results.append((safe_costs, safe_objs, con_costs, con_objs,
                         ...
                         safe_obj_traj, safe_constrs, con_obj_traj,
                          ...
                          problem_config, epbo_obj_traj_0, epbo_constrs_0, epbo_obj_traj_1,
    ...
    for safe_costs, safe_objs, con_costs, con_objs, vabo_costs_tmp, vabo_objs_tmp,\
        ...
        lcb2_constrs, problem_config, epbo_obj_traj_0, epbo_constrs_0, \
        epbo_obj_traj_1, epbo_constrs_1, epbo_obj_traj_2, epbo_constrs_2\
        in multi_results:
        if safe_costs is not None:
            ...
            if True:
                ...
                #print('eppand', epbo_constrs_lists_0
                #      )
...
# In[87]:
    ...
    np.savez(f'./result/test_GP_sample_result_with_pdbo_epbo_GP_beta_{GP_BETA}', safe_ave_cost_arr, safe_ave_simple_regret_arr, con_ave_cost_arr, con_ave_simple_regret_arr, vabo_ave_cost_arr_set,
         ...
         lcb2_constrs_lists, epbo_regret_lists_0, epbo_constrs_lists_0,
         epbo_regret_lists_1, epbo_constrs_lists_1, epbo_regret_lists_2,
        epbo_constrs_lists_2)
